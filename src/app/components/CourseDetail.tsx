                  ...
                  {enrollment.startDate && (
                    <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg">
                      ...
                      <div>
                        ...
                        <p className="font-semibold text-gray-900">{new Date(enrollment.startDate).toLocaleDateString('en-US', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric', timeZone: enrollment.timezone || 'UTC' })}{enrollment.startTime ? ` at ${enrollment.startTime}` : ''}{enrollment.endTime ? ` to ${enrollment.endTime}` : ''}{enrollment.timezone ? ` ${getTzAbbr(enrollment.timezone)}` : ''}</p>
                      </div>
                    </div>
                  )}
                  {enrollment.endDate && (
                    <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg">
                      ...
                      <div>
                        ...
                        <p className="font-semibold text-gray-900">{new Date(enrollment.endDate).toLocaleDateString('en-US', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric', timeZone: enrollment.timezone || 'UTC' })}</p>
                      </div>
                    </div>
                  )}
                  {enrollment.schedule && (
                ...
                <div className="bg-black rounded-t-lg aspect-video flex items-center justify-center relative">
                  {hlsVideoUrl ? (
                    ...
                    <div className="flex flex-col items-center justify-center text-white">
                      ...
                      <p className="text-xs text-gray-500 mt-2">Upload via Cloudflare Stream in course settings</p>
                    </div>
                  )}
                </div>
                <div className="p-6">
