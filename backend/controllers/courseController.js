...
export const browseCourses = async (req, res) => {
  try {
    ...
    const courses = await Course.find(filter)
      .select('_id title description thumbnail specialistEmail courseType status price currency lessons startDate endDate startTime endTime timezone schedule meetingPlatform zoomLink cohortSize liveSessions')
      .sort({ createdAt: -1 });
